...
var config = {
    paths: {
        source: {
            css     : './public/assets/postcss',
            js      : './public/assets/js',
            sprite  : './public/assets/css/images/sprite'
        },
        temp : {
            css     : './public/assets/.temp'
        },
        dist : {
            css     : './public/assets/css',
            js      : './public/assets/js',
            images  : './public/assets/css/images'
        },
        build: {
            path    : './public/assets/build',
            images  : './public/assets/build/images'
        },
        log: {
            csslint : './public/assets/~QA/logs'
        }
    },
    images: {
...
var modules = {
        ...
        var taskCompile = function() {
            ...
            if ( config.css.useFontMagician ) {
                postcssProcessors.push(postcssFontMagician({
                    hosted: './public/assets/css/fonts',
    ...
    html        : function() {
        ...
        var init = function() {
            watch(['./public/assets/*.*html', './public/assets/partials/*.*html', 'templates/*.php', 'fragments/*.php'], function() {
                modules.livereload.reload();
            });
        };
                    ...
                    bs.io.sockets.on('connection', function(socket) {
                        ...
                        socket
                            .on('pixelParallel:save', function(data) {
                                ...
                                fs.readFile('./public/assets/~QA/html-vs-design/settings.json', 'utf8', function (err, response) {
                                    if (err) {
                                        console.log(err);
                                    };
                                    ...
                                    saveJSONToFile('./public/assets/~QA/html-vs-design/settings.json', settings);
                                });
                            })
